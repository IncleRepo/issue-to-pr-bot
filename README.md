...
- Windows: `issue-to-pr-bot-installer-windows-x64.exe`
- Ubuntu/Linux: `issue-to-pr-bot-installer-linux-x64`
...
```powershell
python scripts/build_standalone.py --all
```
