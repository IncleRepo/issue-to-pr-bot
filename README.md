...
- https://github.com/IncleRepo/issue-to-pr-bot/releases/tag/v0.1.0
...
curl -L -o issue-to-pr-bot-installer-linux-x64.tar.gz \
  https://github.com/IncleRepo/issue-to-pr-bot/releases/download/v0.1.0/issue-to-pr-bot-installer-linux-x64.tar.gz
