...
- https://github.com/IncleRepo/issue-to-pr-bot/releases/tag/v0.3.5
...
curl -L -o issue-to-pr-bot-installer-linux-x64.tar.gz \
  https://github.com/IncleRepo/issue-to-pr-bot/releases/download/v0.3.5/issue-to-pr-bot-installer-linux-x64.tar.gz
