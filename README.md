...
- https://github.com/IncleRepo/issue-to-pr-bot/releases/tag/v0.3.2
...
curl -L -o issue-to-pr-bot-installer-linux-x64.tar.gz \
  https://github.com/IncleRepo/issue-to-pr-bot/releases/download/v0.3.2/issue-to-pr-bot-installer-linux-x64.tar.gz
